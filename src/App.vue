...
const hobbies = [{ id: 'Futebol', name: 'Futebol' },
{ id: 'Ler', name: 'Ler' },
...
<template>
  ...
  <div class="container">
    <div class="formulario">
      ...
      <div class="row">
        <label for="senhar">Senha confirma: </label>
        <input type="password" v-model="produto.senhar">
      </div>
      <div class="row">
...
.formulario {
  background-color: rgb(175, 161, 37);
}

.resultado {
  background-color: rgb(52, 206, 14);
}
